...
const mensaje_inicial = "Mi objetivo es ayudarte a crear tus propios prompts personalizados. Juntos identificaremos tus necesidades, objetivos y estilo de aprendizaje o trabajo, para diseñar prompts claros y efectivos. Puedes contarme para qué necesitas el prompt (por ejemplo: estudio, escritura, resolución de problemas) y te ayudaré a formularlo paso a paso.s";
